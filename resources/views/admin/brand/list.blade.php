                	...
                	<div class="row">
			            <div class="col-md-12">
			                <div class="toolbar text-right">
			                	<a href="{{route('admin.brand.add')}}" class="btn btn-success">+ Add Brand</a>
			                </div>
			            </div>
                	</div>
                        ...
                        <table class="datatables table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                	...
                                	<td>{{$item->name}}</td>
                                	<td>
                                		<a href="{{ route('admin.brand.edit', $item->id) }}" rel="tooltip" class="btn btn-success btn-round" data-original-title="Edit" title="Edit">
